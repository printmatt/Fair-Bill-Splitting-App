...
function SignUpUserInBalance({ balanceId, checkIsAuth }) {
    ...
    function handleCreateUserInBalance() {
        ...
        fetch("/twilio-sms/send-otp", {
            ...
            .then((response) => {
                if (response.ok) {
                    ...
                    setAlertMessage("Cannot send verification code to the phone number!");
                    setUserBody({});
    ...
    const onVerificationFormSubmit = event => {
        ...
        fetch("/twilio-sms/verify-otp", {
            ...
            body: JSON.stringify({
                phoneNumber: userBody.phoneNumber.replace(/\D/g, ""),
...
export default SignUpUserInBalance;