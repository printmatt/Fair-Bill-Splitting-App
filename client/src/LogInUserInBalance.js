...
function LogInUserInBalance({balance_id}) {
                    ...
                    fetch("/login", {
                        ...
                        .then((res) => {
                            if (res.ok) {
                                ...
                                navigate('/' + (balance_id !== undefined ? 'balances/' + balance_id : ''));
    ...
    return (
        <div className='App'>
            <Container className='center'>
                <h1>Login To Join This Balance</h1>
            </Container>
...
export default LogInUserInBalance;